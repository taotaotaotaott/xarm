...
speed = 1
for i in range (1,5):
    arm.set_servo_angle(angle=[0, 0, 0, 0, 0, 0], speed=speed, is_radian=False, wait=True, radius=8)
    arm.move_gohome(wait=True)
    # arm.set_servo_angle(angle=[0, -10, -6, 0, 0, 0], speed=speed, is_radian=False, wait=True, radius=-8)
    arm.move_gohome(wait=True)
# arm.set_servo_angle(servo_id=1, angle=45, speed=speed, is_radian=False, wait=True, radius=2)

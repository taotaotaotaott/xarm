...
# arm.set_position(x=30, y=0, z=0, roll=0, pitch=0, yaw=0, speed=5, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=400, y=-100, z=250, roll=180, pitch=0, yaw=0, radius=-50,speed=12, wait=False)
